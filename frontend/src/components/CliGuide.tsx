    ...
    <div className="cli-page">
      ...
      <section className="cli-content">
        ...
        <p className="cli-subtitle animate-fade-in-up stagger-1">
          ...
          Works with Claude Code CLI, Claude Desktop, and Claude Web.
        </p>

        {/* Method 1: Claude Code CLI */}
        <div className="method-section">
          <h2 className="method-title animate-fade-in-up stagger-2">
            <span className="method-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>
            </span>
            Claude Code (CLI)
          </h2>

          <div className="cli-steps">
            <div className="cli-step glass-panel animate-fade-in-up stagger-2">
              <div className="step-number">1</div>
              <div className="step-body">
                <h3>Install the Skill</h3>
                <p>Run this single command in your terminal to download and install ThinkTank:</p>
            ...
            <div className="cli-step glass-panel animate-fade-in-up stagger-3">
            ...
            <div className="cli-step glass-panel animate-fade-in-up stagger-4">
              <div className="step-number">3</div>
              <div className="step-body">
                <h3>Save Tokens with Targeted Debates</h3>
                <p>Append a focus tag to skip irrelevant personas and reduce token consumption by 60%:</p>
                <div className="code-block">
        ...
        {/* Method 2: Claude Desktop / Web */}
        <div className="method-section">
          <h2 className="method-title animate-fade-in-up">
            <span className="method-icon method-icon-purple">
          ...
          <div className="cli-steps">
            <div className="cli-step glass-panel animate-fade-in-up">
              <div className="step-number step-number-purple">1</div>
              <div className="step-body">
                <h3>Download the Skill File</h3>
                <p>Download the <strong>thinktank.skill</strong> file from this repository or use the button below:</p>
            ...
            <div className="cli-step glass-panel animate-fade-in-up">
              ...
              <div className="step-body">
                ...
                <p className="step-note">Drop your <strong>.skill</strong> or <strong>.zip</strong> file into the upload area. The skill will be available immediately.</p>
              </div>
            </div>
            ...
            <div className="cli-step glass-panel animate-fade-in-up">
              ...
              <div className="step-body">
                ...
                <p>Open any conversation and type your architectural question. ThinkTank will automatically activate:</p>
                <div className="code-block">
                  <code>ThinkTank: I want to build a real-time notification system</code>
                </div>
              </div>
